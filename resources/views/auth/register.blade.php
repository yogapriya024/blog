...
<main class="sm:container sm:mx-auto sm:max-w-lg sm:mt-10">
 ...
 <div class="flex flex-wrap">
                        ...
                        <input id="state" type="text" class="form-input w-full @error('state')  border-red-500 @enderror"
 ...
 <div class="flex flex-wrap">
                        <label for="zipcode" class="block text-gray-700 text-sm font-bold mb-2 sm:mb-4">
                            {{ __('Zipcode') }}:
                        </label>

                        <input id="zipcode" type="number" class="form-input w-full @error('zipcode')  border-red-500 @enderror"
